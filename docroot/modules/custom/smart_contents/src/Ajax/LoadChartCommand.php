...
/**
 * Generic AJAX command for LoadChartCommand content.
 *
 ...
 * @ingroup ajax
 */
class LoadChartCommand implements CommandInterface {
...
//  use CommandWithAttachedAssetsTrait;
   ...
   *   An array of JavaScript settings to be passed to any attached behaviors.
   */
  public function __construct($selector, array $arguments = [], array $settings = [],array $data = []) {
